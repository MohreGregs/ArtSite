...
public class CharacterConfiguration : IEntityTypeConfiguration<Character> {
    public void Configure(EntityTypeBuilder<Character> builder)
    {
        ...
        builder.HasOne(x => x.GeneralInfo).WithOne(x => x.Character);
        builder.HasOne(x => x.Personality).WithOne(x => x.Character);
        builder.HasOne(x => x.Interests).WithOne(x => x.Character);
        builder.HasOne(x => x.Appearance).WithOne(x => x.Character);
